...
public class JavaHeapImitationString extends AppCompatActivity implements View.OnClickListener{
    ...
    public static List<char[]> vec;
    private JavaHeapLeakString leak;
    private JavaHeapLeakStringThread t;
...
//    private List<String> list;
    ...
    private class JavaHeapLeakStringThread extends Thread {
        ...
        public void run() {
            ...
            Log.i("Thread info", "JavaHeapLeakStringThread: Process ID: " + Os.getpid() + ", Parent Process ID:" + Os.getppid() + ", Thread ID: " + Os.gettid());
...
//        tmpHeapSize = maxHeapSize;
    ...
    public void onClick(View v){
        ...
        if(v.getId() == R.id.back){
            ...
            leak = new JavaHeapLeakString();
            vec = new ArrayList<>();
            t = new JavaHeapLeakStringThread();
            t.start();
//            btn1.setEnabled(false);
//            btn2.setEnabled(true);
